...
class StarterSite extends Timber\Site {
	...
	public function bootstrap() {
		...
		wp_enqueue_script( 'svg-polyfill', get_template_directory_uri().'/js/actions.js', array('jquery'), '3.3.4', true );
		wp_enqueue_script( 'actions', get_template_directory_uri().'/js/polyfill-svg-uri.min.js', array('jquery'), '3.3.4', true );
	}
